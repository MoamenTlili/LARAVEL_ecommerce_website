            ...
            <div class="profile-desc">
              <div class="profile-pic">
                ...
                <div class="profile-name">
                  <h5 class="mb-0 font-weight-normal"><a href="{{ route('profile.edit') }}">{{ Auth::user()->name }}</a></h5>
                  <span>Admin</span>
                </div>
              </div>
      ...
      <div class="container-fluid page-body-wrapper">
        ...
        <div class="main-panel">
            ...
            <div class="div_center">
              ...
              @csrf
              <input class="input_color" type="text" name="id" placeholder="write id">
              <input class="input_color" type="text" name="name" placeholder="write category name">
              <textarea class="input_color" name="description" placeholder="write description"></textarea>
