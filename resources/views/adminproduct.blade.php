...
<div class="div_design">
    ...
    <div class="div_design">
            ...
            <input class="text_color"  type="number" name="dis_price" placeholder="write discount is applied"> 
    </div>
    <div class="div_design">
    ...
    <div class="div_design">
            ...
            <option value="{{$products->products}}">{{$products->products_name}}</option>
            @endforeach

            </select>
    </div>
    <div class="div_design">
            <label class="div_design">Product Image :</label>
